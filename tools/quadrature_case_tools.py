...
if __name__ == '__main__':
    ...
    allparams = [['输入10个字符，汉字&字母&数字组合', '不输入字符', '输入合法字符加非法字符组合： 【线上化需求% ，<product> ,   线&上化】'],
                 ['不输入字符', '输入10个字符，汉字&字母&数字组合', '输入合法字符加非法字符组合： 【张三% ，<李四> ,   王&五】'],
                 ['选择其中一个标签', '选择所有的标签', '不选择标签'],
                 ['输入1000个字符，汉字&数字&字母&特殊符号组合', '不输入字符'],
                 ['拖动文件上传doc, docx, txt, PDF, xlst, xls.格式的文件，大小小于100M',
                  '上传ZIP, PNG, JPG, RAR, GIF, PY, HTML文件，大小小于100M', '用户在同一个需求上传五个文件，选择合规文件继续上传'], ]
